...
import { authSignupRoute } from '@/utils/APIRoutes';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const response = await axios.post(authSignupRoute, { email, username, password });
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-white px-4 dark:bg-black">
      <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
        ...
        <p className="mt-2 max-w-sm text-sm text-neutral-600 dark:text-neutral-300">
          Create an account to save your analysis history and get insights on your repositories.
        </p>
